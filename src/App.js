...
import Formula from "./Paragraphs/Formula";
const App = () => {
      ...
      <Navbar/>
        <Routes>
          ...
          <Route exact path="/erp-model/data-discription" element={<DataDescription  />} />
              <Route path="/erp-model/sales-item-from-data-discription" element={<Table5 data={Product} header2={"Product Name"} first ={"SrNo"} header3={"Category"} header4={"NO. Of Product Sold"} header5={"Amount"}/>} />
              <Route path="/erp-model/copy-of-data-discription-sales-item" element={<Table5 data={Customer} header2={"Customer ID"} first ={"SrNo"} header3={"City Name"} header4={"State Name"} header5={"Pin Number"}/>} />
          ...
          <Route exact path="/erp-model/profit-prediction" element={<ProfitPrediction />} />
              ...
              <Route path="/erp-model/show-avg-of-predicted-results" element={<Table5 data={predictedAverage} first ={"SrNo"} header2={"Customer ID"} header3={"XG Boost Algorithum"} header4={"Random Forest Algorithum"} header5={"Predicted average"}/>} />
          <Route exact path="/erp-model/Blank" element={<Blank/>} />
            <Route path="/erp-model/derived-algorithm" element={<Formula/>} />
          ...
          <Route exact path="/erp-model/blank-1" element={<Blank1/>} />
            ...
            <Route path="/erp-model/show-wishlist" element={<Table5 data={showWishlistButton4} header2={"Customer ID"} header3={"Items"} header4={"Active Price"} header5={"Price For Our Valuable"}/>} />
